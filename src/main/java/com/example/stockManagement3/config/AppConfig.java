...
import com.example.stockManagement3.entity.Authorities;
...
@ComponentScan(basePackages = "com.example.stockManagement3")
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setAnnotatedClasses(User.class, Authorities.class, Stock.class);
